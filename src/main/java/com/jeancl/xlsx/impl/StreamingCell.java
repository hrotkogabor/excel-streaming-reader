...
public class StreamingCell implements Cell {
	...
	/**
	 * Returns the Row this cell belongs to. Note that keeping references to
	 * cell rows around after the iterator window has passed <b>will</b>
	 * preserve them.
	 *
	...
	/**
	 * Return the cell type. Note that only the numeric, string, and blank types
	 ...
	 *             if the cell type returned by {@link #getCellType()} is
	 *             CELL_TYPE_STRING
	 * @throws NumberFormatException
	 *             if the cell value isn't a parsable <code>double</code>.
	 */
