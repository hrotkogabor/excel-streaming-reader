...
public class StreamingReaderTest {
	...
	public void testTypes() throws Exception {
		...
		InputStream is = new FileInputStream(new File(
				"src/test/resources/data_types.xlsx"));
	...
	public void testMultipleSheets_zulu() throws Exception {
		...
		InputStream is = new FileInputStream(new File(
				"src/test/resources/sheets.xlsx"));
		StreamingReader reader = StreamingReader.builder().sheetIndex(1)
				.read(is);
